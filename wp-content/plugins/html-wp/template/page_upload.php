...
<!--       <div class="mb-6 pt-4">
        ...
        <div class="formbold-mb-5">
         ...
         <label><input type="checkbox" name="page_type" value="builder" class="formbold-form-input addchk"> Website Builder </label>
         <label> <input type="checkbox" name="page_type" value="custom" class="formbold-form-input addchk"> Custom Development</label>
...
if(jQuery('#theme-name').val()!='' && jQuery(document).find('input[type="file"]#file').val()!='' && jQuery(document).find('input[type="file"]#file_screenshot').val()!=''){
  progress();
   ...
   // var caption = jQuery(this).find('input[name=img_caption]');
    ...
    var page_type = jQuery('#page_type option:selected').val();
